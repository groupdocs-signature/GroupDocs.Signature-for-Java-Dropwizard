...
```bash
curl -J -L -o release.tar.gz https://github.com/groupdocs-signature/GroupDocs.Signature-for-Java-Dropwizard/releases/download/1.10.11/release.tar.gz
tar -xvzf release.tar.gz
cd release
java -jar annotation-1.10.11.jar configuration.yaml
## Open http://localhost:8080/signature/ in your favorite browser.
```
